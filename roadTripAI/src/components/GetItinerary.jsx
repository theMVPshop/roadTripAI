...
const GetItinerary = () => {
  ...
  useEffect(() => {
    ...
    // call fetchItinerary after component loads
    useEffect(() => {
      fetchItinerary();
    }, []);
